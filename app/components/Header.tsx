    ...
    <header className="bg-gradient-to-l from-[#FDFBFB] via-[#F1F9FF] to-[#E0F7FA] text-gray-800 shadow-md border-b border-gray-200">
      <div className="relative z-10 px-6 py-4 flex justify-between items-center backdrop-blur-sm">
        ...
        <nav className="flex items-center space-x-4">
          ...
          <a
            href="https://www.jayapradafoundation.org"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center space-x-2 bg-gradient-to-r  hover:from-[#64FFDA] hover:to-[#1DE9B6] transition-all duration-300 rounded-full px-4 py-2 border border-gray-200 shadow-md"
          >
